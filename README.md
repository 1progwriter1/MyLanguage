...
Большую часть времени занимает функция расчета хеша для верификации стека. Уберем эту функцию. Помимо этого отключим `assert()`, отключим верификацию и скомпилируем с флагом оптмизации `-Ofast`.
